...
#output = output + "Clusterwise Variable Selection results: \n ROC_AUC: " + " & ".join([str(item) for item in roc_auc_all]) + "\n precision recall AUC: " +  " & ".join([str(item) for item in auc_all]) + "\n precision: " +  " & ".join([str(item) for item in precision_all]) + "\n recall: " +  " & ".join([str(item) for item in recall_all]) + "\n f1: " +  " & ".join([str(item) for item in f1_all]) + "\n"
